...
const socialLinks = [
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/oniria_investments?igsi=ZnpodmI5ajkyeWtq',
    icon: (
      <svg viewBox="0 0 24 24" aria-hidden="true">
    ...
    <footer className="siteFooter compactFooter">
      <div className="compactFooterTop">
        <div className="compactFooterBrand">
          ...
          <span suppressHydrationWarning>{"We create what doesn't exist yet."}</span>
        </div>
